<div class="container-fluid px-4">
    <div class="d-flex justify-content-start align-items-baseline gap-3">
        <button class="btn btn-primary rounded-5" style="height: 45px" type="button" onclick="loadDeliveryItems()">
                            ...
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="d-flex flex-column gap-1 col-2">
                                    ...
                                    <div class="input-group col p-0">
                                        ...
                                        <div class="col p-0">
                                            <label for="whcode" class="form-label text-dark-emphasis"><small>WHCode:</small></label>
                                    ...
                                    <div class="input-group col p-0">
                                        ...
                                        <div class="col p-0">
                                            <label for="branchWhCode" class="form-label text-dark-emphasis"><small>WHCode:</small></label>
                            ...
                            <div class="d-flex justify-content-start align-items-start mt-5 gap-1">
                                <div class="d-flex flex-column gap-1">
                                    <div>
                                        ...
                                        <input type="text" name="prepby" id="prepby" class="form-control form-control-sm" style="background: #FFFBDF" placeholder="Prepared by" value="Vjay Endoma" readonly>
                                    </div>
                                    <div>
                                        <label for="plate" class="form-label text-dark-emphasis"><small>Truck Plate No:</small></label>
                                        <input type="text" name="plate" id="plate" class="form-control form-control-sm" style="background: #FFFBDF" placeholder="Truck Plate No." value="KGH-345" readonly>
                                    </div>
                                    <div>
                                        <label for="driver" class="form-label text-dark-emphasis"><small>Driver:</small></label>
                                        <input type="text" name="driver" id="driver" class="form-control form-control-sm" style="background: #FFFBDF" placeholder="Driver" value="Roger Amaguin" readonly>
                                    </div>
                                </div>
                                <div>
                                    <label for="remarks" class="form-label text-dark-emphasis"><small>Remarks:</small></label>
                                    <textarea name="remarks" id="remarks" class="form-control form-control-sm" rows="7" style="background: #FFFBDF; height: auto; resize: horizontal" placeholder="Remarks" readonly>
