<form id="frm-add-delivery" method="POST">
    <div class="modal fade" tabindex="-1" id="addDeliveryUnit">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-input mb-2">
                        ...
                        <input type="text" class="form-select form-select-sm" style="background: #FFFBDF" required>
                    </div>
                    <!-- <div class="form-input mb-2">
...
<script>
    ...
    $("#frm-add-delivery").submit(function(event) {
        ...
        // $.post("dirs/outgoing/form/actions/save_deliveryitm.php", {
        //     Serial: Serial,
        //     // Model: Model,
