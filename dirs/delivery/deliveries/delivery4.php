                            ...
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="d-flex flex-column gap-1 col-2">
                                    <div>
                                        ...
                                        <input type="text" name="drno" id="drno" class="form-control form-control-sm" style="background: #FFFBDF" value="DR-10004" readonly>
                                    </div>
                                    <div>
                                        <label for="pcklstno" class="form-label text-dark-emphasis"><small>Picklist No:</small></label>
                                        <input type="text" name="pcklstno" id="pcklstno" class="form-control form-control-sm" style="background: #FFFBDF" value="PL10004" readonly>
                                    </div>
