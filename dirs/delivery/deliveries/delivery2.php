                            ...
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="d-flex flex-column gap-1 col-2">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="pcklstno" id="pcklstno" class="form-control form-control-sm" style="background: #FFFBDF" value="PL10002" readonly>
                                    </div>
                                ...
                                <div class="d-flex flex-column gap-1">
                                    <div>
                                        ...
                                        <input type="text" name="deldate" id="deldate" placeholder="Delivery Date" class="form-control form-control-sm" style="background: #FFFBDF" value="01/30/2026" readonly>
                                    </div>
                                    <div>
                                        <label for="docdate" class="form-label text-dark-emphasis"><small>Document Date:</small></label>
                                        <input type="text" name="docdate" id="docdate" placeholder="Document Date" class="form-control form-control-sm" style="background: #FFFBDF" value="01/30/2026" readonly>
                                    </div>
                                    <div>
                                        <label for="status" class="form-label text-dark-emphasis"><small>Status:</small></label>
                                        <input type="text" name="status" id="status" placeholder="Status" class="form-control form-control-sm" style="background: #FFFBDF" value="COMPLETED" readonly>
                                    </div>
                                </div>
                            </div>
