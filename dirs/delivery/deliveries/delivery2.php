                            ...
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="d-flex flex-column gap-1 col-3">
                                    <div class="form-floating">
                                        <input type="text" name="drno" id="drno" placeholder="DR No." class="form-control" style="background: #FFFBDF" value="DR-10002" readonly>
                                        <label for="drno" class="form-label">DR No.</label>
                                    </div>
                                    <div class="form-floating">
                                        <input type="text" name="pcklstno" id="pcklstno" placeholder="Picklist No." class="form-control" style="background: #FFFBDF" value="PL10002" readonly>
