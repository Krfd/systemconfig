<div class="container-fluid px-4">
    <div class="d-flex justify-content-start align-items-baseline gap-3">
        <button class="btn btn-primary rounded-5" style="height: 40px" type="button" onclick="loaditem2()">
                            ...
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="d-flex flex-column gap-1 col-3">
                                    <div>
                                        ...
                                        <input type="text" name="srn" id="srn" value="SRNVIAC0001" class="form-control form-control-sm" style="background: #FFFBDF" disabled required readonly>
                                    </div>
                                    <div>
                                    ...
                                    <div class="input-group">
                                        <div>
                                            ...
                                            <select name="origin" id="origin" class="form-select form-select-sm" placeholder="Origin" style="background: #FFFBDF" required disabled readonly>
                                ...
                                <div class="d-flex flex-column gap-1">
                                    <div>
                                        ...
                                        <input type="text" name="date" id="date" class="form-control" style="background: #FFFBDF" value="01/30/2026" required disabled readonly>
                                    </div>
                                    <div>
                                        <label for="status" class="form-label text-dark-emphasis"><small>Status:</small></label>
                                        <input type="text" name="status" id="status" value="NEW" class="form-control" style="background: #FFFBDF" required disabled readonly>
                                    </div>
                                </div>
                            </div>
