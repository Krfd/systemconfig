<div class="container-fluid px-4">
    <div class="d-flex justify-content-start align-items-baseline gap-3">
        <button class="btn btn-primary rounded-5" style="height: 40px" type="button" onclick="loaditem5()">
                            ...
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="d-flex flex-column gap-1 col-3">
                                    <div>
                                        ...
                                        <input type="text" name="srn" id="srn" value="SRNPLZA0005" class="form-control form-control-sm" style="background: #FFFBDF" disabled required readonly>
                                    </div>
                                    <div>
                            ...
                            <div class="d-flex justify-content-between align-items-end mt-5">
                                <div class="d-flex flex-column gap-1">
                                    <div>
                                        ...
                                        <input type="text" name="purpose" id="purpose" class="form-control form-control-sm" style="background: #FFFBDF" placeholder="Purpose of Request" value="Transfer" disabled required>
                                    </div>
                                    <div>
