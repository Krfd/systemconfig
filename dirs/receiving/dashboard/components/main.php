<ul class="nav nav-tabs nav-tabs-bordered d-flex mt-5" id="borderedTabJustified" role="tablist">
    ...
    <li class="nav-item flex-fill" role="presentation">
        <button class="nav-link w-100" id="drafts-tab" data-bs-toggle="tab" data-bs-target="#bordered-justified-assigned" type="button" role="tab" aria-controls="drafts" aria-selected="false">Drafts</button>
    </li>
</ul>
<div class="tab-content mt-3" id="borderedTabJustifiedContent">
    <div class="tab-pane fade shadow active" id="bordered-justified-all" role="tabpanel" aria-labelledby="received-tab">
    ...
    <div class="tab-pane fade" id="bordered-justified-assigned" role="tabpanel" aria-labelledby="drafts-tab">
        <div class="table-responsive">
