                                ...
                                <div class="d-flex justify-content-start align-items-start gap-1 col-7">
                                    <div class="d-flex flex-column gap-1">
                                        <div class="d-flex align-items-baseline gap-3">
                                            ...
                                            <input type="text" name="receiveByRecForm" id="receiveByRecForm" class="form-control form-control-sm col" style="background: #f2f2f2" value="<?php echo isset($user['Username']) ? $user['Username'] : '' ?>" readonly required>
                                        </div>
                                        <div class="d-flex align-items-baseline gap-3">
