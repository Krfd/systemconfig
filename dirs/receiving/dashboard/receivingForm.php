                            ...
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="d-flex flex-column gap-1 col-4">
                                    <div class="d-flex align-items-baseline gap-3">
                                        ...
                                        <input type="text" name="rrNoRecForm" id="rrNoRecForm" class="form-control form-control-sm col" style="background: #f2f2f2" disabled readonly>
                                    </div>
                                    <div class="d-flex align-items-baseline gap-3">
                                        <label for="srnRecForm" class="form-label text-dark-emphasis col-3"><small>SRN:</small></label>
                                        <input type="text" name="srnRecForm" id="srnRecForm" class="form-control form-control-sm col" style="background: #f2f2f2" disabled readonly>
                                    </div>
                                    <div class="input-group col p-0 d-flex gap-1">
                                        <div class="col p-0 d-flex align-items-baseline gap-1 col-7">
                                            ...
                                            <input type="text" name="originRecForm" class="form-control form-control-sm ms-3" value="PLAZA" style="background: #f2f2f2" disabled readonly required>
                                        </div>
                                        <div class="col p-0 d-flex align-items-baseline gap-1">
                                            ...
                                            <input type="text" name="origRecForm" class="form-control form-control-sm" value="PLZA" style="background: #f2f2f2" readonly disabled required>
                                        </div>
                                    </div>
                                    <div class="input-group col p-0 d-flex align-items-baseline gap-1">
                                        <div class="col p-0 d-flex align-items-baseline gap-1 col-7">
                                            ...
                                            <input type="text" name="desRecForm" class="form-control form-control-sm ms-3" value="VIAC" style="background: #f2f2f2" readonly disabled required>
                                        </div>
                                        <div class="col p-0 d-flex align-items-baseline">
                                            ...
                                            <input type="text" name="originCodeRecForm" class="form-control form-control-sm" value="VIAC" style="background: #f2f2f2" readonly disabled required>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex flex-column gap-1 col-3">
                                    ...
                                    <div class="d-flex align-items-baseline gap-3">
                                        ...
                                        <input type="text" name="docDateRecForm" id="docDateRecForm" class="form-control form-control-sm col" style="background: #f2f2f2" disabled readonly>
                                    </div>
                                    <div class="d-flex align-items-baseline gap-3">
                                        <label for="statusRecForm" class="form-label text-dark-emphasis col-4"><small>Status:</small></label>
                                        <input type="text" name="statusRecForm" id="statusRecForm" class="form-control form-control-sm col" style="background: #f2f2f2" disabled readonly>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="d-flex justify-content-start align-items-end gap-1 col-7">
                                    <div class="d-flex flex-column gap-1">
                                        <div class="d-flex align-items-baseline gap-3">
                                            ...
                                            <input type="text" name="receiveByRecForm" id="receiveByRecForm" class="form-control form-control-sm col" style="background: #f2f2f2" readonly disabled required>
                                        </div>
                                        <div class="d-flex align-items-baseline gap-3">
                                            <label for=" plateRecForm" class="form-label text-dark-emphasis col-5"><small>Truck Plate No:</small></label>
                                            <input type="text" name="plateRecForm" id="plateRecForm" class="form-control form-control-sm col" style="background: #f2f2f2" readonly disabled required>
                                        </div>
                                        <div class="d-flex align-items-baseline gap-3">
                                            <label for=" driverRecForm" class="form-label text-dark-emphasis col-5"><small>Driver:</small></label>
                                            <input type="text" name="driverRecForm" id="driverRecForm" class="form-control form-control-sm col" style="background: #f2f2f2" readonly disabled required>
                                        </div>
                                    </div>
                                    <div class="col-3">
                                        <label for=" remarksRecForm" class="form-label text-dark-emphasis"><small>Remarks:</small></label>
                                        <textarea name="remarksRecForm" id="remarksRecForm" class="form-control form-control-sm col" rows="3" style="background: #f2f2f2; height: auto;" disabled readonly></textarea>
                                    </div>
                                </div>
