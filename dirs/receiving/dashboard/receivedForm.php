...
<div class="container-fluid px-4">
    <div class="d-flex justify-content-start align-items-baseline gap-3">
        ...
        <div class="d-flex justify-content-start align-items-start gap-3">
            <h3 class="fw-bold text-primary"> <!-- Received Items --><span id="rcvdNumber"></span></h3>
        </div>
    </div>
                    ...
                    <div class="row">
                        <form method="POST" id="receivingForm">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="d-flex flex-column gap-1 col-4">
                                    <div class="d-flex align-items-baseline gap-3">
                                        ...
                                        <input type="text" name="drNoRecForm" id="drNoRecForm" class="form-control form-control-sm col search-order-field" data-field="deliveryNumber" style="background: #f2f2f2" oninput="this.value = this.value.toUpperCase()">
                                    </div>
                                    <div class="d-flex align-items-baseline gap-3">
                                        <label for="refNoRecForm" class="form-label text-dark-emphasis col-3"><small>Reference No:</small></label>
                                        <input type="text" name="refNoRecForm" id="refNoRecForm" class="form-control form-control-sm col search-order-field" data-field="referenceNumber" style="background: #f2f2f2" oninput="this.value = this.value.toUpperCase()">
                                    </div>
                                    <div class="d-flex align-items-baseline gap-3">
                                        <label for="stockReqNoRecForm" class="form-label text-dark-emphasis col-3"><small>Stock Request No:</small></label>
                                        <input type="text" name="stockReqNoRecForm" id="stockReqNoRecForm" class="form-control form-control-sm col search-order-field" data-field="stockReqNumber" style="background: #f2f2f2" oninput="this.value = this.value.toUpperCase()">
                                    </div>
                                    <div class="input-group col p-0 d-flex gap-1">
                                        <div class="col p-0 d-flex align-items-baseline gap-1 col-7">
                                            ...
                                            <input type="text" name="originRecForm" id="originRecForm" class="form-control form-control-sm ms-3" value="NEWSC1" style="background: #f2f2f2" readonly required>
                                        </div>
                                        <div class="col p-0 d-flex align-items-baseline gap-1">
                                            ...
                                            <input type="text" name="origRecForm" id="origCodeRecForm" class="form-control form-control-sm" value="NEWWHS" style="background: #f2f2f2" readonly required>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="totalRowOutside" class="d-flex border-top fw-bold"
                                ...
                                <div class="p-2" style="width:120px;" id="totalReceivingQty">0</div>
                            </div>
                                ...
                                <div class="d-flex justify-content-start align-items-start gap-1 col-7">
                                    <div class="d-flex flex-column gap-1">
                                        <div class="d-flex align-items-baseline gap-3">
                                            ...
                                            <input type="text" name="receiveByRecForm" id="receiveByRecForm" class="form-control form-control-sm col" style="background: #f2f2f2" readonly>
                                        </div>
                                        <div class="d-flex align-items-baseline gap-3">
                                            <label for=" driverRecForm" class="form-label text-dark-emphasis col-5"><small>Driver:</small></label>
                                            <input type="text" name="driverRecForm" id="driverRecForm" class="form-control form-control-sm col" style="background: #f2f2f2" readonly>
                                        </div>
                                        <div class="d-flex align-items-baseline gap-3">
                                            <label for="truckCat" class="form-label text-dark-emphasis col-5"><small>Truck Category:</small></label>
                                            <input type="text" name="truckCat" id="truckCat" class="form-control form-control-sm col" style="background: #f2f2f2" readonly>
                                        </div>
                                        <div class="d-flex align-items-baseline gap-3">
                                            <label for=" plateRecForm" class="form-label text-dark-emphasis col-5"><small>Truck Plate No:</small></label>
                                            <input type="text" name="plateRecForm" id="plateRecForm" class="form-control form-control-sm col" style="background: #f2f2f2" readonly>
                                        </div>
                                    </div>
                                    <div class="col-3">
