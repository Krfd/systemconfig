                            ...
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="d-flex flex-column gap-1 col-4">
                                    ...
                                    <div class="d-flex align-items-baseline gap-3">
                                        ...
                                        <input type="text" name="typeOfReq" id="typeOfReq" class="form-control form-control-sm col" style="background: #f2f2f2" readonly>
                                    </div>
                                    <div class="input-group col p-0 d-flex gap-1">
                                        <div class="col p-0 d-flex align-items-baseline gap-1 col-7">
                                            ...
                                            <input type="text" name="destination" id="destination" class="form-control form-control-sm col ms-3" style="background: #f2f2f2" readonly>
                                        </div>
                                        <div class="col p-0 d-flex align-items-baseline col">
                                            ...
                                            <input type="text" name="branchWhCode" id="branchWhCode" class="form-control form-control-sm col" style="background: #f2f2f2" readonly>
                                        </div>
                                    </div>
                                    <div class="input-group col p-0 d-flex align-items-baseline gap-1">
                                        <div class="col p-0 d-flex align-items-baseline gap-1 col-7">
                                            ...
                                            <input type="text" name="origin" id="origin" class="form-control form-control-sm col ms-3" style="background: #f2f2f2" readonly>
                                        </div>
                                        <div class="col p-0 d-flex align-items-baseline">
                                            ...
                                            <input type="text" name="whcode" id="whcode" class="form-control form-control-sm col" style="background: #f2f2f2" readonly>
                                        </div>
                                    </div>
                                </div>
