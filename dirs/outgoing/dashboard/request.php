                                ...
                                <div class="d-flex flex-column gap-1 col-4">
                                    ...
                                    <div class="input-group col p-0 d-flex gap-1">
                                        <div class="col p-0 d-flex align-items-baseline gap-1 col-7">
                                            ...
                                            <input type="text" name="destination" id="destination" class="form-control form-control-sm col" style="background: #f7f7f7" readonly>
                                        </div>
                                    ...
                                    <div class="input-group col p-0 d-flex align-items-baseline gap-1">
                                        <div class="col p-0 d-flex align-items-baseline gap-1 col-7">
                                            ...
                                            <input type="text" name="origin" id="origin" class="form-control form-control-sm col" style="background: #f7f7f7" readonly>
                                        </div>
