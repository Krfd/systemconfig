<div class="container-fluid px-4">
    <div class="d-flex justify-content-start align-items-baseline gap-3">
        <button class="btn btn-primary rounded-5" style="height: 40px" type="button" onclick="returnOutgoing()">
                            ...
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="d-flex flex-column gap-1 col-3">
                                    <div class="form-floating">
                                        <input type="text" name="srn" id="srn" placeholder="SRN" value="SRNSHOW0002" class="form-control" style="background: #FFFBDF" disabled required readonly>
                                ...
                                <div class="d-flex flex-column gap-1">
                                    ...
                                    <div class="form-floating">
                                        <input type="text" name="status" id="status" placeholder="Status" value="IN TRANSIT" class="form-control" style="background: #FFFBDF" required disabled readonly>
