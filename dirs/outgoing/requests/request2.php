                            ...
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="d-flex flex-column gap-1 col-2">
                                    <div>
                                        ...
                                        <input type="text" name="srn" id="srn" value="SRNSHOW0002" class="form-control form-control-sm" style="background: #FFFBDF" disabled required readonly>
                                    </div>
                                    <div>
                                    ...
                                    <div class="input-group col p-0">
                                        ...
                                        <div class="col p-0">
                                            ...
                                            <select name="whcode" id="whcode" class="form-select form-select-sm" style="background: #FFFBDF" required disabled readonly>
                                                <option value="newswh">NEWSWH</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                <div class="d-flex flex-column gap-1">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="status" id="status" value="IN TRANSIT" class="form-control form-control-sm" style="background: #FFFBDF" required disabled readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-between align-items-end mt-5">
                                <div class="d-flex flex-column gap-1">
                                    <div>
                                        ...
                                        <input type="text" name="type" id="type" class="form-control form-control-sm" style="background: #FFFBDF" placeholder="Purpose of Request" value="Transfer" disabled required>

                                    </div>
                                    <div>
                                        <label for="reqBy" class="form-label text-dark-emphasis"><small>Requested by:</small></label>
                                        <input type="text" name="reqBy" id="reqBy" class="form-control form-control-sm" style="background: #FFFBDF" placeholder="Requested by" value="Carmelo Arroyo" disabled readonly required>

                                    </div>
                                    <div>
                                        <label for="remarks" class="form-label text-dark-emphasis"><small>Remarks:</small></label>
                                        <textarea name="remarks" id="remarks" class="form-control form-control-sm" rows="3" style="background: #FFFBDF; height: auto" placeholder="Remarks" disabled>Please transfer the following unit, ASAP.</textarea>
