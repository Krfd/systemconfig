                    ...
                    <div class="row">
                        <form method="POST" id="deliver">
                            <div class="d-flex justify-content-between align-items-start">
                                ...
                                <div class="d-flex flex-column gap-1 col-3">
                                    ...
                                    <div class="d-flex align-items-baseline gap-3">
                                        ...
                                        <input type="text" name="statusForm" id="statusForm" class="form-control form-control-sm col" style="background: #F7F7F7" value="PREPARING" readonly required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-start align-items-end mt-5 gap-1">
                                ...
                                <div class="ms-auto">
                                    <button class="clearfix btn btn-primary float-end" type="submit" id="deliveryBtn">Submit</button>
                                </div>
                            </div>
                        </form>
                    </div>
