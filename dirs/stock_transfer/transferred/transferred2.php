                            ...
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="d-flex flex-column gap-1 col-2">
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="center" id="center" class="form-control form-select-sm" style="background: #FFFBDF" value="SHOWREPOWH" readonly>
                                    </div>
                                    <div>
                                        <label for="appcode" class="form-label text-dark-emphasis"><small>Approval Code:</small></label>
                                        <input type="text" name="appcode" id="appcode" class="form-control form-select-sm" style="background: #FFFBDF" readonly>
                                    </div>
                                </div>
                                <div class="d-flex flex-column gap-1">
                                    <div>
                                        <label for="strno" class="form-label text-dark-emphasis"><small>STR No:</small></label>
                                        <input type="text" name="strno" id="strno" class="form-control form-select-sm" style="background: #FFFBDF" value="STR-10002" readonly>
                                    </div>
                                    <div>
                                        <label for="date" class="form-label text-dark-emphasis"><small>Date:</small></label>
                                        <input type="text" name="date" id="date" class="form-control form-select-sm" style="background: #FFFBDF" value="01/30/2026" readonly>
                                    </div>
                                    <div>
                                        <label for="status" class="form-label text-dark-emphasis"><small>Status:</small></label>
                                        <input type="text" name="status" id="status" class="form-control form-select-sm" style="background: #FFFBDF" value="PARTIAL" readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="d-flex justify-content-start align-items-start mt-5 gap-1">
                                <div class="d-flex flex-column gap-1">
                                    <div>
                                        ...
                                        <textarea name="remarks" id="remarks" class="form-control form-select-sm" rows="7" style="background: #FFFBDF; height: auto; resize: horizontal" readonly>
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="prepby" id="prepby" class="form-control form-select-sm" style="background: #FFFBDF" value="Vjay Endoma" readonly>
                                    </div>
                                </div>
                            </div>
                        </form>
