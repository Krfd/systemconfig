                        ...
                        <form method="POST" id="transferredForm">
                            <div class="d-flex justify-content-between align-items-start">
                                ...
                                <div class="d-flex flex-column gap-1">
                                    <div class="form-floating">
                                        <input type="text" name="strno" id="strno" placeholder="STR No." class="form-control" style="background: #FFFBDF" value="STR-10001" readonly>
                                    ...
                                    <div class="form-floating">
                                        <input type="text" name="status" id="status" placeholder="Status" class="form-control" style="background: #FFFBDF" value="COMPLETED" readonly>
