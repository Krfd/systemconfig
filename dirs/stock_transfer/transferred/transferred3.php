<div class="container-fluid px-4">
    <div class="d-flex justify-content-start align-items-baseline gap-3">
        <button class="btn btn-primary rounded-5" style="height: 40px" type="button" onclick="stockTransferDashboard()">
                        ...
                        <form method="POST" id="transferredForm">
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="d-flex flex-column gap-1 col-3">
                                    ...
                                    <div class="form-floating">
                                        <input type="text" name="center" id="center" placeholder="Service Center" class="form-control" style="background: #FFFBDF" value="SHOWREPOWH" readonly>
                                        <label for="center" class="form-label">Service Center</label>
                                    </div>
                                    <div class="form-floating">
                                        <input type="text" name="appcode" id="appcode" placeholder="Approval Code" class="form-control" style="background: #FFFBDF" readonly>
                                        <label for="appcode" class="form-label">Approval Code</label>
                                    </div>
                                </div>
                                <div class="d-flex flex-column gap-1">
                                    <div class="form-floating">
                                        <input type="text" name="strno" id="strno" placeholder="STR No." class="form-control" style="background: #FFFBDF" value="STR-10003" readonly>
                                        <label for="strno" class="form-label">STR No.</label>
                                    </div>
                                    <div class="form-floating">
                                        <input type="text" name="date" id="date" placeholder="Date" class="form-control" style="background: #FFFBDF" value="01/30/2026" readonly>
                                        <label for="date" class="form-label">Date</label>
                                    </div>
                                    <div class="form-floating">
                                        <input type="text" name="status" id="status" placeholder="Status" class="form-control" style="background: #FFFBDF" value="TERMINATED" readonly>
