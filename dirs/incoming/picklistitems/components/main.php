    ...
    <table class="table datatables table-hover" id="outgoingTable">
        ...
        <tbody>
            <tr style="height: 40px; min-height: 40px">
                <td class="text-primary ps-2 align-middle" onclick="openIncoming()" style="cursor: pointer; background: #FFFBDF; padding: 3px">SRN10001</td>
                ...
                <td class="d-flex gap-1 dropdown dropstart align-middle" style="background: #FFFBDF; padding: 3px">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="#" class="dropdown-item" onclick="openIncoming()">Open</a></li>
