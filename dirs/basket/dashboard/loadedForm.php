                            ...
                            <div class="d-flex justify-content-between align-items-start">
                                <div class="d-flex flex-column gap-1 col-4">
                                    <div class="d-flex align-items-baseline gap-3">
                                        ...
                                        <input type="text" name="drno" id="drno" class="form-control form-control-sm col" style="background: #f2f2f2" value="DR-10001" readonly>
                                    </div>
                                    <div class="d-flex align-items-baseline gap-3">
                                        <label for="pcklstno" class="form-label text-dark-emphasis col-3"><small>Picklist No:</small></label>
                                        <input type="text" name="pcklstno" id="pcklstno" class="form-control form-control-sm col" style="background: #f2f2f2" value="PL10001" readonly>
                                    </div>
                                    <div class="input-group col p-0 d-flex gap-1">
                                        <div class="col p-0 d-flex align-items-baseline gap-1 col-7">
                                            ...
                                            <select name="origin" id="origin" class="form-select form-select-sm col ms-3" style="background: #f2f2f2" readonly>
                                        ...
                                        <div class="col p-0 d-flex align-items-baseline col">
                                            ...
                                            <select name="whcode" id="whcode" class="form-select form-select-sm col" style="background: #f2f2f2" readonly>
                                    ...
                                    <div class="input-group col p-0 d-flex align-items-baseline gap-1">
                                        <div class="col p-0 d-flex align-items-baseline gap-1 col-7">
                                            ...
                                            <select name="branchName" id="branchName" class="form-select form-select-sm col ms-3" style="background: #f2f2f2;" readonly>
                                        ...
                                        <div class="col p-0 d-flex align-items-baseline">
                                            ...
                                            <select name="branchWhCode" id="branchWhCode" class="form-select form-select-sm col" style="background: #f2f2f2" readonly>
                                ...
                                <div class="d-flex flex-column gap-1 col-3">
                                    <div class="d-flex align-items-baseline gap-3">
                                        ...
                                        <input type="text" name="deldate" id="deldate" class="form-control form-control-sm col" style="background: #f2f2f2" value="01/30/2026" readonly>
                                    </div>
                                    <div class="d-flex align-items-baseline gap-3">
                                        <label for="docdate" class="form-label text-dark-emphasis col-4"><small>Document Date:</small></label>
                                        <input type="text" name="docdate" id="docdate" class="form-control form-control-sm col" style="background: #f2f2f2" value="01/30/2026" readonly>
                                    </div>
                                    <div class="d-flex align-items-baseline gap-3">
                            ...
                            <div class="d-flex justify-content-start align-items-start mt-5 gap-1">
                                <div class="d-flex flex-column gap-1 col-3">
                                    ...
                                    <div class="d-flex align-items-baseline gap-3">
                                        ...
                                        <input type="text" name="plate" id="plate" class="form-control form-control-sm col" style="background: #f2f2f2" readonly>
                                    </div>
                                    <div class="d-flex align-items-baseline gap-3">
                                        <label for="driver" class="form-label text-dark-emphasis col-4"><small>Driver:</small></label>
                                        <input type="text" name="driver" id="driver" class="form-control form-control-sm col" style="background: #f2f2f2" readonly>
                                    </div>
                                </div>
                                <div class="col-2">
                                    <label for="remarks" class="form-label text-dark-emphasis"><small>Remarks:</small></label>
                                    <textarea name="remarks" id="remarks" class="form-control form-control-sm" rows="3" style="background: #f2f2f2; height: auto; resize: horizontal" readonly>
